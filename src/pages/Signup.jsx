...
export default function Signup() {
    ...
    return (
        <div className="min-h-screen flex bg-white dark:bg-gray-900 transition-colors duration-200 font-sans">
            {/* Left Side - Form (Swapped for Signup to creating unique feel) */}
            <div className="flex-1 flex items-center justify-center p-4 sm:p-12 lg:p-24 relative order-2 lg:order-1">
                <Link to="/" className="absolute top-8 left-8 text-sm font-medium text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                    Back to Home
                </Link>
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    >
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Start Building</h2>
                        <p className="mt-2 text-gray-500 dark:text-gray-400">
                            Create your account to start deploying AI agents.
                        </p>
                    </motion.div>
            ...
            {/* Right Side - Brand & Visuals (Order 1 on mobile to be top, Order 2 on desktop to be right) */}
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-purple-600 dark:bg-purple-900 order-1 lg:order-2">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-purple-600/90 to-indigo-700/90 dark:from-purple-900/90 dark:to-indigo-900/90"></div>

                <div className="relative w-full flex flex-col justify-center p-12 text-white z-10">
                    <motion.div
                    ...
                    >
                        ...
                        <p className="text-lg text-purple-100 max-w-sm">
                            No credit card required. Get 100 free messages to test our powerful RAG engine.
                        </p>
                    </motion.div>

                    <div className="grid grid-cols-2 gap-4">
                        {[
                            { label: 'Chatbots', value: '1,000+' },
                            { label: 'Messages', value: '50M+' },
